...
<head>
<script type="text/javascript" src="${pageContext.request.contextPath}/admin/js/ace/admin.msgbox.js"></script>
...
<body>
					...
					<div class="span12">
						<div class="content-widgets ">
							...
							<div class="box well form-inline">
								...
								<input type="text" id="_name" placeholder="内容">
								<a onclick="$.msgbox.initSearchDataTable()"
	...
	<div class="modal hide fade" id="_modal">
		...
		<div class="modal-footer center" id="div_footer">
			<a class="btn btn-primary" onclick="$.msgbox.saveUser()">保存</a>
