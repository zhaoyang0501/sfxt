					...
					<div class="content-widgets ">
							...
							<div class="row-fluid ">
								<table class="responsive table table-striped table-bordered"
									...
									<tbody>
									<c:forEach items="${fees }" var="bean">
									 <tr>
									 	<td>${bean.user.username }</td>
									 	<td>${bean.user.name }</td>
									 	<td>${bean.user.grade.name }</td>
									 	<td>${bean.year }</td>
									 	<td>${bean.createDate }</td>
									 	<td><span class="badge badge-success">${bean.needfee}</span></td>
									 	<td><span class="badge badge-success">${bean.payfee}</span></td>
									 	<td><span class="badge badge-important">${bean.lastfee}</span></td>
