...
<head>
<script type="text/javascript" src="${pageContext.request.contextPath}/admin/js/ace/admin.standard.js"></script>
...
<body>
					...
					<div class="span12">
						<div class="content-widgets ">
							...
							<div class="box well form-inline">
								...
								<a onclick="$.standard.initSearchDataTable()"
	...
	<div class="modal hide fade" id="_modal">
				...
				<div class="span12">
					<div class="form-container grid-form form-background left-align form-horizontal">
						<form action="" method="get" id=''>
							<input type="hidden"  name='grade.id' id="id" value="">
							<input type="hidden"  name='year' id="year" value="">
							
								<c:forEach items="${categorys }" var="bean"  varStatus="status">
								<input type="hidden"  name='items[${status.index}].category.id' id="id" value="${bean.id }">
							
									<div class="control-group">
									<label for="title" class="control-label">${bean.name }：</label>
									<div class="controls">
										<input type="text" name='items[${status.index}].fee' id="cash" placeholder="">
									</div>
								</div>
								</c:forEach>
		...
		<div class="modal-footer center" id="div_footer">
			<a class="btn btn-primary" onclick="$.standard.saveUser()">保存</a>
