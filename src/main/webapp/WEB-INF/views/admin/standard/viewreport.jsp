	...
	<script type="text/javascript">
		$(function() {
		 ...
		 function AllAreaWord()
		 {
		  ...
		  sel.moveToElementText(dayoffform);
		  sel.select();
	...
	<div class="layout">
		...
		<div class="main-wrapper">
			<div class="container-fluid">
				<div class="row-fluid ">
					<div class="span12">
						<div class="content-widgets " id='worddiv'>
						<div class="widget-head  bondi-blue">
							<h3>课堂教学督导评价综合意见表</h3>
						</div>
						<div class="widget-container">
						<button type="button" onclick="javascript:AllAreaWord();" class='btn btn-primary' style="float: right;">导出word</button>
